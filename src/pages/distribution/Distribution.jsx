...
const recentNotes = [
  {
    author: "Sarah Miller",
    time: "2h ago",
    text: "Expressed interest in the premium enterprise tier. Wants a demo scheduled for next Tuesday at 10...",
  },
  {
    author: "John Doe",
    time: "5h ago",
    text: "Left a voicemail. Follow up if no response by EOD tomorrow. Priority high.",
  },
];

const upcomingTasks = [
  {
    title: "Call Sarah Miller",
    time: "Today, 2:00 PM",
    icon: Phone,
  },
  {
    title: "Send Proposal to Robert",
                  ...
                  >
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <button
                            onClick={() => navigate(`/distribution/assigned-leads/${lead.id}`)}
                    ...
                    <td className="px-6 py-6">
                      <span
                        className={`inline-flex rounded-full px-3 py-1 text-[11px] font-black ${leadStatusClasses(
                          lead.status
                        )}`}
                      >
                        {lead.status}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {recentNotes.map((note) => (
                <div key={note.author} className="app-panel p-6">
          ...
          <div>
            ...
            <div className="space-y-5">
              {upcomingTasks.map((task) => {
                ...
                return (
                  <div key={task.title} className="app-panel flex items-center gap-4 p-6">
